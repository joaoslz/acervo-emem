...
public class ConsultasRepository<T> implements Serializable {
	...
	public List<T> findAll() {
		// IMPORTANTE:Cada entidade deve implementar a named query
		// Entidade.findAll
	...
	/**
	 * Este método funciona com ilike para atributos do tipo string e equals
	...
	public PaginatedResult<T> findFilteredAndPaginate(Map<String, Object> filters, int firstResult, int maxResultsByPage) {
		...
		for (Map.Entry<String, Object> e : filters.entrySet()) {
			if (e.getValue() instanceof Short || e.getValue() instanceof Integer || e.getValue() instanceof Long || e.getValue() instanceof Float
