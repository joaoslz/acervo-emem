...
/**
 * Converter Generico. Bem mais simples e prática, não precisa consultar no
 * banco de dados, como nos anteriores.
 */
@Named
public class EntityConverter implements Converter {
	...
	public String getAsString(FacesContext ctx, UIComponent component, Object obj) {
		if (obj == null)
			return "";
		try {
			// adiciona o objeto no mapa do componente para recuperá-lo
			// posteriormente.
